...
export type RandomChannelQuery = {
  __typename?: "Query";
  randomChannel: {
    __typename?: "ChannelForPlaylistResponse";
    id: number;
...
export type ChannelsCountQuery = {
  __typename?: "Query";
 ...
 * });
 */
export function useRandomChannelQuery(
  baseOptions?: Apollo.QueryHookOptions<
    RandomChannelQuery,
    RandomChannelQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<RandomChannelQuery, RandomChannelQueryVariables>(
    RandomChannelDocument,
    options
  );
}
export function useRandomChannelLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<RandomChannelQuery, RandomChannelQueryVariables>(
    RandomChannelDocument,
    options
  );
}
export function useRandomChannelSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
  ...
  return Apollo.useSuspenseQuery<
    RandomChannelQuery,
    RandomChannelQueryVariables
  >(RandomChannelDocument, options);
}
export type RandomChannelQueryHookResult = ReturnType<
  typeof useRandomChannelQuery
>;
export type RandomChannelLazyQueryHookResult = ReturnType<
  typeof useRandomChannelLazyQuery
>;
export type RandomChannelSuspenseQueryHookResult = ReturnType<
  typeof useRandomChannelSuspenseQuery
>;
export type RandomChannelQueryResult = Apollo.QueryResult<
  RandomChannelQuery,
  RandomChannelQueryVariables
>;
 ...
 * });
 */
export function useChannelsCountQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ChannelsCountQuery,
    ChannelsCountQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ChannelsCountQuery, ChannelsCountQueryVariables>(
    ChannelsCountDocument,
    options
  );
}
export function useChannelsCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ChannelsCountQuery,
    ChannelsCountQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ChannelsCountQuery, ChannelsCountQueryVariables>(
    ChannelsCountDocument,
    options
  );
}
export function useChannelsCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        ChannelsCountQuery,
  ...
  return Apollo.useSuspenseQuery<
    ChannelsCountQuery,
    ChannelsCountQueryVariables
  >(ChannelsCountDocument, options);
}
export type ChannelsCountQueryHookResult = ReturnType<
  typeof useChannelsCountQuery
>;
export type ChannelsCountLazyQueryHookResult = ReturnType<
  typeof useChannelsCountLazyQuery
>;
export type ChannelsCountSuspenseQueryHookResult = ReturnType<
  typeof useChannelsCountSuspenseQuery
>;
export type ChannelsCountQueryResult = Apollo.QueryResult<
  ChannelsCountQuery,
  ChannelsCountQueryVariables
>;
